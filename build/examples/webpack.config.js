...
export default {
  ...
  resolve: {
    ...
    alias: {
      ...
      'tiptap-commands-v1': path.resolve(rootPath, '../packages/tiptap-commands-v1/src'),
      'tiptap-utils-v1': path.resolve(rootPath, '../packages/tiptap-utils-v1/src'),
      'tiptap-models-v1': path.resolve(rootPath, '../packages/tiptap-models-v1/src'),
      'tiptap-extensions-v1': path.resolve(rootPath, '../packages/tiptap-extensions-v1/src'),
    },
    modules: [
      srcPath,
